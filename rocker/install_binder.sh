...
pip3 install --no-cache-dir jupyter-rsession-proxy ipywidgets==7.6.3 jupyterlab==3.0.7 notebook==6.2.0 nteract_on_jupyter==2.1.3 pm4py pandas matplotlib plotnine
